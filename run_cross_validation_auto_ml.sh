...
wekaCV () {
  if [[ "$1" == "weka" ]]; then
    ...
    do
      ...
      java -cp ../autoweka/temps/autoweka.jar:/home/simonprovost34430/weka-3-8-5/weka.jar weka.classifiers.meta.AutoWEKAClassifier -t $FILE_TRAIN -T $FILE_TEST -timeLimit 8 -seed 85 -memLimit 5000 -nBestConfigs 50 > "$2$i.log"
    done
  fi
}
...
python3 main_obesity_dataset.py "./params/params_seed_85_one_hour.params" > ./outputAutoML/ObesityDataset_raw_and_data_synthetic/one_hour_experiment_seed_85.log cv $1
...
echo "First experiment seed 85 (one hour):"
python3 main_diabetes_dataset.py "./params/params_seed_85_one_hour.params" > ./outputAutoML/diabetic-retinopathy-Debrecen/one_hour_experiment_seed_85.log cv $1
...
echo "First experiment seed 85 (one hour):"
python3 main_thoracic_surgery_datasets.py "./params/params_seed_85_one_hour.params" > ./outputAutoML/Thoracic-Surgery-binary-survival/one_hour_experiment_seed_85.log cv $1
...
echo "First experiment seed 85 (one hour):"
python3 main_breast_cancer_dataset.py "./params/params_seed_85_one_hour.params" > ./outputAutoML/Breast-cancer-Coimbra/one_hour_experiment_seed_85.log cv $1
...
echo "First experiment seed 85 (one hour):"
python3 main_hearth_failure_dataset.py "./params/params_seed_85_one_hour.params" > ./outputAutoML/Heart-failure-clinical-records/one_hour_experiment_seed_85.log cv $1
